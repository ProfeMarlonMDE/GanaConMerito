...
title: Caricatura de Mafalda
area: lectura_critica
subarea: proposito_comunicativo
examType: docente
...
#### Opciones
* A. Legitima el silencio y la obediencia como virtudes necesarias para mantener el orden y el respeto en el aula facilitando la labor pedagógica de los adultos.
...
title: Lectura de informe de la realidad institucional
area: lectura_critica
subarea: analisis_argumentativo
examType: docente
competency: evaluacion_de_informacion
difficulty: 0.30
targetLevel: basico
itemType: multiple_choice
normativeRefs: []
...
#### Opciones
* A. Establece una relación de contrastes porque no hay coherencia entre el discurso de las políticas educativas y la realidad de la institución.
...
title: Análisis de crónica periodística local
area: lectura_critica
subarea: interpretacion_textual
examType: docente
competency: comprension_local
difficulty: 0.50
...
#### Opciones
* A. Analizar expresiones culturales del texto estableciendo relaciones con prácticas sociales reales que fortalezcan la comprensión del mensaje propuesto por el autor.
...
title: Voces en texto argumentativo
area: lectura_critica
subarea: estructura_textual
examType: docente
competency: interpretacion_textual
difficulty: 0.60
targetLevel: intermedio
itemType: multiple_choice
normativeRefs: []
...
#### Opciones
* A. Comparar cada perspectiva del texto reconociendo quién la emite cómo se construye y qué función cumple en el argumento del autor.
...
title: Texto técnico sobre salud pública escolar
area: lectura_critica
subarea: analisis_argumentativo
examType: docente
competency: evaluacion_de_informacion
...
#### Opciones
* A. Relacionar los datos del texto con situaciones reales de la institución construyendo conexiones críticas entre el contenido y su experiencia profesional local.
