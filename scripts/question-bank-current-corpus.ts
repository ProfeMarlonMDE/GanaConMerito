...
export const LEGACY_SAMPLE_FILES = [
  "content/items/matematicas/razonamiento-matematico-001.md",
  "content/items/normatividad/caso-convivencia-001.md",
  "content/items/pedagogia/planeacion-aula-001.md",
] as const;
